...
class HaxeStub
{
	...
	public static function startHarryCamera(arg0:Int, arg1:String):Void
	{
		if (_startHarryCamera_func == null)
			_startHarryCamera_func = openfl.utils.JNI.createStaticMethod("com/weiplus/client/HaxeStub", "startHarryCamera", "(ILjava/lang/String;)V", true);
		var a = new Array<Dynamic>();
        a.push(arg0);
        a.push(arg1);
