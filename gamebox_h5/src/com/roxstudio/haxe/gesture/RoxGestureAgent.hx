...
//    private static inline var DOUBLE_TAP_DELAY = 0.3;
    ...
    private static var buttonDown: Bool = false;
    ...
    private inline static function init() {
        if (!initialized) {
            ...
            stage.addEventListener(MouseEvent.MOUSE_UP, onStageMouse);
//            stage.addEventListener(MouseEvent.MOUSE_OUT, onStageMouse);
//            stage.addEventListener(MouseEvent.MOUSE_MOVE, onStageMouse);
        }
    }

    private static function onStageMouse(e: MouseEvent) {
        switch (e.type) {
...
//        trace("onMouse:e=" + e + ",buttonDown=" + buttonDown);
        var t: String = e.type;
        if (t == MouseEvent.MOUSE_DOWN || t == MouseEvent.MOUSE_UP || buttonDown) {
