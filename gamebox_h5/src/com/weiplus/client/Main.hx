...
//        flash.Lib.current.addEventListener(MouseEvent.MOUSE_DOWN, function(_) {});
//        flash.Lib.current.addEventListener(MouseEvent.MOUSE_UP, function(_) {});
//        flash.Lib.current.addEventListener(MouseEvent.MOUSE_OUT, function(_) {});
//        flash.Lib.current.addEventListener(MouseEvent.MOUSE_MOVE, function(_) {});
//        flash.Lib.current.addEventListener(MouseEvent.MOUSE_OVER, function(_) {});
//        flash.Lib.current.addEventListener(MouseEvent.MOUSE_WHEEL, function(_) {});
    }
