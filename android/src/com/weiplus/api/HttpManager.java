...
//	private static final String BOUNDARY = "7cd4a6d158c";
	 ...
	 * @return 响应结果
	 * @throws WeiplusException
	 */
	public static String openUrl(String url, String method, WeiplusParameters params, String file) throws WeiplusException {
		String result = "";
		try {
			...
			if (statusCode != 200) {
				...
				throw new WeiplusException(result, statusCode);
			}
			result = readHttpResponse(response);
			return result;
		} catch (IOException e) {
			throw new WeiplusException(e);
		}
	}
...
//			}
	...
	private static void paramToUpload(OutputStream baos, WeiplusParameters params)
			throws WeiplusException {
		String key = "";
	...
	private static void imageContentToUpload(OutputStream out, String imgpath) throws WeiplusException {
		if(imgpath==null){
		    return;
		}
